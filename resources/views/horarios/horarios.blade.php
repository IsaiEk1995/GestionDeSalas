        ...
        <div class="col-xs-12">
          ...
          <div class="row">
            ...
            <table class="table">
              ...
              <th><font color="white"><center>Id Horario</center></font></th>
              <th><font color="white"><center>Horario</center></font></th>
        ...
        <div class="modal-content">
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <center><input type="text" name="id_horario" v-model="id_horario" class="form-control"><br> 

              <label>Horario</label>
              <input type="text" name="horario" placeholder="horario" v-model="nombre" class="form-control" ><br> 
        ...
        <div class="modal-content">
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <label>Id Horario</label>
              <input type="text" name="id_horario" v-model="id_horario" class="form-control" disabled=""><br> 

              <label>Horario</label>
              <input type="text" name="horario" v-model="horario" class="form-control"><br> 
