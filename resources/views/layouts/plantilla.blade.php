		...
		<section class="full-box nav-lateral">
			...
			<div class="full-box nav-lateral-content">
				...
				<nav class="full-box nav-lateral-menu">
					<ul>
						<li>
						<p class="font-italic"><a href="escritorio"><i class="fab fa-dashcube fa-fw"></i>&nbsp; Dashboard</a>
						</li></p>
						...
						<li>
							...
							<ul>
								<li>
								<p class="font-italic"><a href="sala"><i class="fas fa-circle fa-fw"></i> &nbsp; Administrar Salas</a></p>
								</li>
								<li>
						...
						<li>
							...
							<ul>
								<li>
								<p class="font-italic"><a href="adminis"><i class="fas fa-circle fa-fw"></i> &nbsp; Historial De Solicitudes</a></p>
								</li>
							</ul>
						</li>

						<li>
							<a href="#" class="nav-btn-submenu"><p class="font-italic"><i class="fas fa-cog fa-fw"></i> &nbsp; Configuraciones <i class="fas fa-chevron-down"></i></p></a>
							<ul>
								<li>
								<p class="font-italic"><a href="horas"><i class="fas fa-circle fa-fw"></i> &nbsp; Horarios</a></p>
								</li>
								<li>
									<p class="font-italic"><a href="administradores"><i class="fas fa-circle fa-fw"></i> &nbsp; Usuarios</a>
								</li>
							</ul>
						</li>
					</ul>
